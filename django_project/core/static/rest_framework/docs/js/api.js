...
$(document).ready(function () {
    $('#selected-authentication').html('api-key');
    $('#auth-control').html('' +
        '<li class="active">api-key : ' +
        '<input type="text" name="api-key" id="api-key" style="height: 20px;"></li>');
    $('*[data-target="#auth-control"]').click();
    $("input[name='api-key']").closest('.form-group').remove();
});