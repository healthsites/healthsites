...
urlpatterns = patterns(
    ...
    url(
        r'^localities.json$',
        LocalitiesLayer.as_view(),
        name='localities'
    ),
    url(
        r'^localities/(?P<uuid>\w{32})$',
        LocalityInfo.as_view(),
        name='locality-info'
    ),
    url(
        r'^localities/(?P<uuid>\w{32})/(?P<changes>[0-9].*)$',
        LocalityInfo.as_view(),
        name='locality-info-history'
    ),
    url(
        r'^localities/edit$',
        'localities.views.locality_edit_view',
        name='locality-edit'
    ),
    url(
        r'^localities/create$',
        'localities.views.locality_create_view',
    ...
    url(
        r'^upload-form$',
        DataLoaderView.as_view(),
        name='upload-form'
    ),
    url(
        r'^load-data$',
        'localities.views.load_data',
        name='load-data'
    ),
    url(
        r'^report$',
